...
?>
 ...
 if ($result['firstname'] == "Superadmin" or $result['email'] == "injection_master_1337@inbox.uz")
 {
     echo " | You are radmin here is your flag: <b>nuu_flag{1njection_m4ster_1337}</b>";
 }
 else
 {
     echo " You are not Superadmin. You can't see the flag.";
 }
 ?>
